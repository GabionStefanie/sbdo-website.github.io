...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="payments-css.css">
    <script src="https://unpkg.com/just-validate@latest/dist/just-validate.production.min.js" defer></script>
    <script src = "payments-validation.js" defer></script>
    <style>
...
<form method="post" action="process_payment.php" enctype="multipart/form-data" id="payments-html" novalidate>
 <div>
    <div>
