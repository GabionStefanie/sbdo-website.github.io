    ...
    <div class="APPOINTMENT-FORM-container">
        <form action="backend/process-appstep2.php" method="post" id="appstep2" novalidate>
            ...
            <div class="input-group">
                ...
                <div id= "dentalpain" class="flex-group">
            ...
            <div class="input-group">
                <label>WHAT IS YOUR PAIN LEVEL? (1 (ALMOST NO PAIN) TO 10 (EXTREMELY PAINFUL))</label>
                <div>
            ...
            <div class="input-group">
                ...
                <div id= "dentaltrauma" class="flex-group">
            ...
            <div class="input-group">
                ...
                <div id= "bleedingtissues" class="flex-group">
